...
k1(1,i) = Vqs(1,i)-(Rs*Iqs(1,i))-(Wf*Lamds(1,i));
m1(1,i) = Vds(1,i)-(Rs*Ids(1,i))+(Wf*Lamqs(1,i));
...
Lamos2(1,i) = Lamos(1,i) + (n1(1,i)*(h/2));
 ...
 k2(1,i) = Vqs(1,i)-(Rs*Iqs(1,i))-(Wf*Lamds2(1,i));
 m2(1,i) = Vds(1,i)-(Rs*Ids(1,i))+(Wf*Lamqs2(1,i));
...
Lamos3(1,i) = Lamos2(1,i) + (n2(1,i)*(h/2));
 ...
 k3(1,i) = Vqs(1,i)-(Rs*Iqs(1,i))-(Wf*Lamds3(1,i));
 m3(1,i) = Vds(1,i)-(Rs*Ids(1,i))+(Wf*Lamqs3(1,i));
...
Lamos4(1,i) = Lamos3(1,i) + (n3(1,i)*(h/2));
  ...
  k4(1,i) = Vqs(1,i)-(Rs*Iqs(1,i))-(Wf*Lamds4(1,i));
  m4(1,i) = Vds(1,i)-(Rs*Ids(1,i))+(Wf*Lamqs4(1,i));
...
z1(1,i) = Vqr(1,i)-(Rr*Iqr(1,i))-(Wrr*Lamdr(1,i));
x1(1,i) = Vdr(1,i)-(Rr*Idr(1,i))+(Wrr*Lamqr(1,i));
c1(1,i) = Vor(1,i)-(Rr*Ior(1,i));
...
Lamor2(1,i) = Lamor(1,i) + (c1(1,i)*(h/2));
 ...
 z2(1,i) = Vqr(1,i)-(Rr*Iqr(1,i))-(Wrr*Lamdr2(1,i));
 x2(1,i) = Vdr(1,i)-(Rr*Idr(1,i))+(Wrr*Lamqr2(1,i));
 c2(1,i) = Vor(1,i)-(Rr*Ior(1,i));
...
Lamor3(1,i) = Lamor2(1,i) + (c2(1,i)*(h/2));
 ...
 z3(1,i) = Vqr(1,i)-(Rr*Iqr(1,i))-(Wrr*Lamdr3(1,i));
 x3(1,i) = Vdr(1,i)-(Rr*Idr(1,i))+(Wrr*Lamqr3(1,i));
 c3(1,i) = Vor(1,i)-(Rr*Ior(1,i));
...
Lamor4(1,i) = Lamor3(1,i) + (n3(1,i)*(h/2));
  ...
  z4(1,i) = Vqr(1,i)-(Rr*Iqr(1,i))-(Wrr*Lamdr4(1,i));
  x4(1,i) = Vdr(1,i)-(Rr*Idr(1,i))+(Wrr*Lamqr4(1,i));
  c4(1,i) = Vor(1,i)-(Rr*Ior(1,i));

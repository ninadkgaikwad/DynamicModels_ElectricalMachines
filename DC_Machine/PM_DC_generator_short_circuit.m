...
for i = 1:length(t1);
    ...
    k1(1,i) =  -(Ra/Laa)*Ia1(1,i) - (Kv/Laa)*Wr1(1,i);
    ...
    Ia2(1,i) = Ia1(1,i) + (k1(1,i)*(h/2));
     ...
     k2(1,i) =  -(Ra/Laa)*Ia2(1,i) - (Kv/Laa)*Wr2(1,i);
    ...
    Ia3(1,i) = Ia1(1,i) + (k2(1,i)*(h/2));
     ...
     k3(1,i) =  -(Ra/Laa)*Ia3(1,i) - (Kv/Laa)*Wr3(1,i);
    ...
    k4(1,i) =  -(Ra/Laa)*Ia4(1,i) - (Kv/Laa)*Wr4(1,i);
    ...
    figure(2)
    Ia1new = abs(Ia1(1,(1:length(Ia1)-1)));
    plot(t1,Ia1new,'b');
